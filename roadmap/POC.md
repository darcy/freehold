...
*   **CPA system-prompt:** The CPA's purpose, tone, and toolset boundaries live in a single Markdown file
    (`platform/agents/freehold/prompt.md`, embedded into the `freehold-orchestrator`
...
*   CPA's purpose is defined by `platform/agents/freehold/prompt.md`; changing the file and redeploying
