...
// TestRunWholeWorldTeardownBailsWithoutSession proves the CP-driven whole-world
// teardown is fail-closed: on a box with no operator session it returns an
// actionable error rather than fabricating one.
