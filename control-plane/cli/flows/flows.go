// Package flows is the scripted flows (E1/E2) port — originally the
// orchestrator's flows.rs: enabling an existing service (onboard), connecting
// to a running runner, reading readiness, running scripted demo steps.
//
